<b>  I developed a web application which was a  StudentDetailsManagementSystem for a company. The main goal was to create an interface where employees could input data into the database and then download it in CSV format to compile various reports.
...
-  <b> 1. &nbsp; Clone Git Repo  </b>
    <br>----<i> git clone https://github.com/Shivamdubey28/EmployeeDataManagementSystem.git </i><br><br>
...
-  <b> 6.Deployment </b>
   <p>The application was deployed using cloud services like render, depending on the preferred platform. 
## Author


- Name: Shivam Dubey
- GitHub: <a><b>https://github.com/Shivamdubey28/EmployeeDataManagementSystem</a></b>
- Email: 
- Website: 
